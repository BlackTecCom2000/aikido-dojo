...
export const translations: Record<Language, TranslationSchema> = {
  ru: {
    ...
    hero: {
      ...
      chiefSenseiBadge: "Под руководством Шихана Абдуллозода Ҷумъахон (6 Дан Айкикай)",
    ...
    instructors: {
      ...
      lineageText: "О-Сэнсэй Морихэй Уэсиба → Всемирный центр Айкидо Айкикай (Токио) → Шихан Абдуллозода Ҷумъахон",
      chiefMasterTitle: "Президент Федерации и Главный Инструктор",
      ...
      items: [
        {
          ...
          role: "Шихан / Главный Инструктор Додзё / Президент Федерации",
          rank: "6-й Дан Айкидо Айкикай (Токио)",
        ...
        {
          id: "inst-2",
          name: "Искандар Рахимов",
          role: "Старший Сэнсэй / Ведущий инструктор",
          rank: "4-й Дан Айкидо Айкикай",
        ...
        {
          id: "inst-3",
          name: "Мавлюда Каримова",
          role: "Инструктор детских и женских групп",
          rank: "3-й Дан Айкидо Айкикай",
    ...
    auth: {
      ...
      approvedBy: "Одобрено: Шихан Абдуллозода Ҷумъахон (6 Дан)",
    ...
    footer: {
      ...
      chiefMaster: "Главный Наставник: Шихан Абдуллозода Ҷумъахон (6 Дан)",
  ...
  en: {
    ...
    hero: {
      ...
      chiefSenseiBadge: "Directed by Shihan Abdullozoda Jumakhon (6th Dan Aikikai)",
    ...
    instructors: {
      ...
      lineageText: "O-Sensei Morihei Ueshiba → Aikikai Hombu Dojo (Tokyo) → Shihan Abdullozoda Jumakhon",
      chiefMasterTitle: "Federation President & Chief Instructor",
      ...
      items: [
        {
          id: "inst-1",
          name: "Abdullozoda Jumakhon",
          role: "Shihan / Chief Instructor / Federation President",
          rank: "6th Dan Aikikai (Tokyo, Japan)",
        ...
        },
        {
          ...
          role: "Senior Sensei / Lead Instructor",
          rank: "4th Dan Aikikai",
        ...
        {
          id: "inst-3",
          name: "Mavlyuda Karimova",
          role: "Youth & Women's Program Director",
    ...
    footer: {
      ...
      chiefMaster: "Chief Master: Shihan Abdullozoda Jumakhon (6th Dan Aikikai)",
  ...
  tg: {
    ...
    hero: {
      ...
      chiefSenseiBadge: "Таҳти роҳбарии Шиҳон Абдуллозода Ҷумъахон (Дани 6-уми Айкикай)",
    ...
    instructors: {
      ...
      lineageText: "О-Сэнсэй Морихэй Уэсиба → Маркази умумиҷаҳонии Айкикай (Токио) → Шиҳон Абдуллозода Ҷумъахон",
      chiefMasterTitle: "Президенти Федератсия ва Сармураббии Додзё",
      ...
      items: [
        {
          id: "inst-1",
          name: "Абдуллозода Ҷумъахон",
          role: "Шиҳон / Сармураббии Додзё / Президенти Федератсия",
          rank: "Дани 6-уми Айкидо Айкикай (Токио)",
        ...
        {
          id: "inst-2",
          name: "Искандар Раҳимов",
          role: "Сэнсэйи Калон / Мураббии пешбар",
          rank: "Дани 4-уми Айкикай",
        ...
        {
          id: "inst-3",
          name: "Мавлуда Каримова",
          role: "Роҳбари бахши кӯдакон ва бонувон",
          rank: "Дани 3-юми Айкикай",
    ...
    footer: {
      ...
      chiefMaster: "Сармураббӣ: Шиҳон Абдуллозода Ҷумъахон (Дани 6-уми Айкикай)",
